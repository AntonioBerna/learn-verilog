...
// - c_enable, c_load, c_d[3:0] Control signals going to the provided 4-bit counter,
//   so correct operation can be verified.
// You have the following components available:
// - the 4-bit binary counter (count4) below, which has Enable and synchronous
//   parallel-load inputs (load has higher priority than enable). The count4 module is provided
//   to you. Instantiate it in your circuit.
// - logic gates
// ```verilog
// module count4(
// 	input clk,

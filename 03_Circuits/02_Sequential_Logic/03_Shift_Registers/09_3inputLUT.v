...
// The circuit's behaviour should be as follows: when ABC is 000, Z=Q[0],
// when ABC is 001, Z=Q[1], and so on. Your circuit should contain ONLY the 8-bit shift register,

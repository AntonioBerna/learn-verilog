...
// A more verbose way of expressing this rule is the following table, where a cell's next state
// is a function of itself and its two neighbours:
...
// - https://en.wikipedia.org/wiki/Rule_90#Sierpi.C5.84ski_triangle
